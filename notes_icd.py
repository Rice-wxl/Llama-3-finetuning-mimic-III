...
import os
os.environ["WANDB_PROJECT"] = "<llama_3_finetuning_icdcodes>"  # name your W&B project
...
dataset_name = "wangrice/MIMIC-III-Notes-ICD-IDLess2500"
...
def formatting_prompts_func(examples):
    notes  =  examples["TEXT"]
    icd_codes = examples["ICD9_CODE"]
    texts = []
    for note, code in zip(notes, icd_codes):
      answer = None
      try:
        value = int(code)
